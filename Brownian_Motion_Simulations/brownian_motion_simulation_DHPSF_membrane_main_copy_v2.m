...
%for cytoF = 0:0.2:1
    ...
    %%Need to include capability to simulate in the transmitted channel as
    %%well. 5/5/2021 Alecia Achimovich
    ...
    %from.
    meanPhotons = 2000;% Modified from 3500 to reflect higher brightness of dye
    photonsStd = 100;
